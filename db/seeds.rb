...
UserPermission1 = UserPermission.create(user_id: superadmin.id, permission_id: permission1.id.id.id.id.id.id.id.id)
UserPermission2 = UserPermission.create(user_id: superadmin.id, permission_id: permission2.id.id.id.id.id.id.id)
UserPermission3 = UserPermission.create(user_id: superadmin.id, permission_id: permission3.id.id.id.id.id.id)
UserPermission4 = UserPermission.create(user_id: superadmin.id, permission_id: permission4.id.id.id.id.id)
UserPermission5 = UserPermission.create(user_id: superadmin.id, permission_id: permission5.id.id.id.id)
UserPermission6 = UserPermission.create(user_id: superadmin.id, permission_id: permission6.id.id.id)
UserPermission7 = UserPermission.create(user_id: superadmin.id, permission_id: permission7.id.id)
