...
permission13 = Permission.create(module_name: 'User', operation: 'reset_pwd', is_show: false)
permission14 = Permission.create(module_name: 'FrontUser', operation: 'read')
permission15 = Permission.create(module_name: 'FrontUser', operation: 'update')
permission16 = Permission.create(module_name: 'Stamp', operation: 'read')
permission17 = Permission.create(module_name: 'Stamp', operation: 'create')
permission18 = Permission.create(module_name: 'Stamp', operation: 'update')
permission19 = Permission.create(module_name: 'Stamp', operation: 'destroy')
